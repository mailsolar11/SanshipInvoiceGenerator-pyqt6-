...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # 3. Apply Initial Theme (Split/Light by default per recent fix)
        self.current_mode = "LIGHT" # Start with Full Light as per "Beautiful" ref, or "SPLIT"? 
                                    # Let's stick to "SPLIT" (Original Beautiful) as default, toggling to DARK/LIGHT
        ...
        self.btn_reports = self.create_nav_btn("Reports", 3)
        ...
        self.stack.addWidget(self.page_invoice)
        self.stack.addWidget(self.page_debit)
    ...
    def switch_tab(self, index):
        ...
        btns = [self.btn_invoice, self.btn_debit, self.btn_customers, self.btn_reports]
        if 0 <= index < len(btns):
